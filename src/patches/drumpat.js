...
export default function run(codeInterface){
    ...
    let envelope = codeInterface.create(codeInterface.possibleModules.EnvelopeGenerator);
    let filter = codeInterface.create(codeInterface.possibleModules.Filter);
    ...
    let noiseFilter = codeInterface.create(codeInterface.possibleModules.Filter);

    let delay = codeInterface.create(codeInterface.possibleModules.Delay);
